...
namespace OpenTemenos.DataHubs.OperationalDataStore.Party.ParticipantLists
{
    ...
    public partial class GetParticipantListResponse 
    {
        ...
        public GetParticipantListResponseBody? Data { get; set; }= default!;
    
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GetParticipantListResponseBody 
    {
        /// <summary>Helps in grouping together users</summary>
        [Newtonsoft.Json.JsonProperty("pwParticipant", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<PwParticipant>? PwParticipant { get; set; }= default!;
    
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class PwParticipant 
    {
        ...
        public AccountOfficer? AccountOfficer { get; set; }= default!;
    ...
    public partial class AccountOfficer 
    {
        /// <summary>Identifier of Department Account Officer</summary>
        [Newtonsoft.Json.JsonProperty("accountOfficer", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AccountOfficer1 { get; set; }= default!;
