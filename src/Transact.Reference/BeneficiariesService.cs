...
namespace Transact.Reference.Beneficiaries
{
    ...
    public partial interface IBeneficiariesService
    {
        ...
        System.Threading.Tasks.Task<UtilityBeneficiariesResponse> GetUtilityBeneficiariesAsync(string? companyName, string? companyNameCT, string? beneficiaryId, string? beneficiaryAccountId, string? bankSortCode, string? transactionType, string? preferredPaymentProductId, string? beneficiaryIBAN, string? customerId, int? page_size, int? page_start, string? page_token, string? credentials, string? companyId, string? deviceId, string? userRole, bool? disablePagination);
        ...
        /// <returns>UtilityBeneficiariesResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<UtilityBeneficiariesResponse> GetUtilityBeneficiariesAsync(string? companyName, string? companyNameCT, string? beneficiaryId, string? beneficiaryAccountId, string? bankSortCode, string? transactionType, string? preferredPaymentProductId, string? beneficiaryIBAN, string? customerId, int? page_size, int? page_start, string? page_token, string? credentials, string? companyId, string? deviceId, string? userRole, bool? disablePagination, System.Threading.CancellationToken cancellationToken);
