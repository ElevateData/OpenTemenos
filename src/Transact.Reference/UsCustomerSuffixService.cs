...
namespace Transact.Reference.UsCustomerSuffixs
{
    ...
    /// <summary>UsSuffixListResponse</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v13.0.0.0)")]
    public partial class UsSuffixListResponse 
    {
        [System.Text.Json.Serialization.JsonPropertyName("header")]
        public QueryHeader? Header { get; set; }= default!;
    
        [System.Text.Json.Serialization.JsonPropertyName("body")]
        public UsSuffixListResponseBody? Body { get; set; }= default!;
    
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v13.0.0.0)")]
    public partial class UsSuffixListResponseBody : System.Collections.ObjectModel.Collection<Anonymous>
    {
    ...
    {
        /// <summary>Post-nominal letters that indicate that the individual holds a position, educational degree, accreditation, office, or honor.Allowed values can be retrieved through getEbLookups for virtualTableName USREGS.CUS.SUFFIX</summary>
