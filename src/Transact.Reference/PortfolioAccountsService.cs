...
namespace Transact.Reference.PortfolioAccounts
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.14.5.0 (NJsonSchema v10.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial interface IPortfolioAccountsService
    {
        ...
        System.Threading.Tasks.Task<ReferencePortfolioAccountsResponse> GetPortfolioAccountsAsync(string portfolioId, string? customerId, int? page_size, int? page_start, string? page_token, string? credentials, string? companyId);
        ...
        /// <returns>PortfolioAccountsResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ReferencePortfolioAccountsResponse> GetPortfolioAccountsAsync(string portfolioId, string? customerId, int? page_size, int? page_start, string? page_token, string? credentials, string? companyId, System.Threading.CancellationToken cancellationToken);
