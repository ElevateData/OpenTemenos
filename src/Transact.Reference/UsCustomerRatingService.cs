...
namespace Transact.Reference.UsCustomerRating
{
    ...
    public partial interface IUsCustomerRatingService
    {
        ...
        System.Threading.Tasks.Task<UsCustomerRatinglistResponse> GetUsCustomerRatinglistAsync(int? page_size, int? page_start, string? page_token, string? credentials, string? companyId);
        ...
        /// <returns>UsCustomerRatinglistResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<UsCustomerRatinglistResponse> GetUsCustomerRatinglistAsync(int? page_size, int? page_start, string? page_token, string? credentials, string? companyId, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("RatingIds")]
