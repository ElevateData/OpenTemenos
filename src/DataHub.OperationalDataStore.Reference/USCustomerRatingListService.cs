...
namespace DataHub.OperationalDataStore.Reference.USCustomerRatingList
{
    ...
    public partial interface IUSCustomerRatingListService
    {
        ...
        System.Threading.Tasks.Task<GetUSCustomerRatingListResponse> GetUSCustomerRatingListAsync(string? recordId);
        ...
        /// <returns>US model bank - customer risk ratingResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetUSCustomerRatingListResponse> GetUSCustomerRatingListAsync(string? recordId, System.Threading.CancellationToken cancellationToken);
