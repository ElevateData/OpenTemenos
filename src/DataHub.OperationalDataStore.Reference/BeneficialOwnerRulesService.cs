...
namespace DataHub.OperationalDataStore.Reference.BeneficialOwnerRules
{
    ...
    public partial interface IBeneficialOwnerRulesService
    {
        ...
        System.Threading.Tasks.Task<GetBeneficialOwnerRulesResponse> GetBeneficialOwnerRulesAsync();
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Retrieves the list of Beneficiary Role type definitions and the information that is mandatory for the role definition</summary>
        /// <returns>getBeneficialOwnerRulesResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetBeneficialOwnerRulesResponse> GetBeneficialOwnerRulesAsync(System.Threading.CancellationToken cancellationToken);
