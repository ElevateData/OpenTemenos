...
namespace DataHub.OperationalDataStore.Reference.USIndustrylist
{
    ...
    public partial interface IUSIndustrylistService
    {
        ...
        System.Threading.Tasks.Task<GetUSIndustrylistResponse> GetUSIndustrylistAsync(string? recordId);
        ...
        /// <returns>getUSIndustrylistResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetUSIndustrylistResponse> GetUSIndustrylistAsync(string? recordId, System.Threading.CancellationToken cancellationToken);
