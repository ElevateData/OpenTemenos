...
namespace DataHub.OperationalDataStore.Reference.CurrenciesDetails
{
    ...
    public partial interface ICurrenciesDetailsService
    {
        ...
        System.Threading.Tasks.Task<GetCurrenciesResponse> GetCurrenciesAsync(string? recordId);
        ...
        /// <returns>getCurrenciesResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetCurrenciesResponse> GetCurrenciesAsync(string? recordId, System.Threading.CancellationToken cancellationToken);
    
        /// <summary>Retrieves the details of a specific currency</summary>
        /// <param name="recordId">Unique identifier of an entity</param>
        /// <returns>getCurrencyResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetCurrencyResponse> GetCurrencyAsync(string recordId);
        ...
        /// <returns>getCurrencyResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetCurrencyResponse> GetCurrencyAsync(string recordId, System.Threading.CancellationToken cancellationToken);
