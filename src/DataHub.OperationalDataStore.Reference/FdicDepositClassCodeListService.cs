...
namespace DataHub.OperationalDataStore.Reference.FdicDepositClassCodeList
{
    ...
    public partial interface IFdicDepositClassCodeListService
    {
        ...
        System.Threading.Tasks.Task<GetFdicDepositClassCodeListResponse> GetFdicDepositClassCodeListAsync(string? recordId);
        ...
        /// <returns>getFdicDepositClassCodeListResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetFdicDepositClassCodeListResponse> GetFdicDepositClassCodeListAsync(string? recordId, System.Threading.CancellationToken cancellationToken);
