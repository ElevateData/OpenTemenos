...
namespace OpenTemenos.DataHubs.AnalyticDataStore.Holding.AllCustomerTransactionCounts
{
    ...
    public partial class CustomerTransactionSummary 
    {
        ...
        [Newtonsoft.Json.JsonProperty("totalPrincipalAmount", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
