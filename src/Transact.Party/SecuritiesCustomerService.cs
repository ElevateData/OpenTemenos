...
namespace Transact.Party.SecuritiesCustomerX
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.14.5.0 (NJsonSchema v10.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial interface ISecuritiesCustomerService
    {
        /// <summary>Retrieves the security customer</summary>
        /// <param name="customerId">Identifier of the customer</param>
        /// <returns>SecuritiesCustomerResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SecuritiesCustomerResponse> GetSecuritiesCustomerAsync(string customerId, string? credentials, string? companyId);
        ...
        /// <returns>SecuritiesCustomerResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SecuritiesCustomerResponse> GetSecuritiesCustomerAsync(string customerId, string? credentials, string? companyId, System.Threading.CancellationToken cancellationToken);
    
        /// <summary>Creates a security customer</summary>
        /// <param name="customerId">Identifier of the customer</param>
        /// <param name="payload">body Payload</param>
        /// <param name="validate_only">The identifier to indicate if it is set to only validate or not.</param>
        /// <returns>SecuritiesCustomerResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SecuritiesCustomerResponse> CreateSecuritiesCustomerAsync(string customerId, SecuritiesCustomer payload, bool? validate_only, string? credentials, string? companyId);
        ...
        /// <returns>SecuritiesCustomerResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SecuritiesCustomerResponse> CreateSecuritiesCustomerAsync(string customerId, SecuritiesCustomer payload, bool? validate_only, string? credentials, string? companyId, System.Threading.CancellationToken cancellationToken);
    
        /// <summary>Updates the security customer</summary>
        /// <param name="customerId">Identifier of the customer</param>
        /// <param name="payload">body Payload</param>
        /// <param name="validate_only">The identifier to indicate if it is set to only validate or not.</param>
        /// <returns>SecuritiesCustomerResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SecuritiesCustomerResponse> UpdateSecuritiesCustomerAsync(string customerId, SecuritiesCustomer payload, bool? validate_only, string? credentials, string? companyId);
        ...
        /// <returns>SecuritiesCustomerResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SecuritiesCustomerResponse> UpdateSecuritiesCustomerAsync(string customerId, SecuritiesCustomer payload, bool? validate_only, string? credentials, string? companyId, System.Threading.CancellationToken cancellationToken);
    ...
    /// <summary>SecuritiesCustomer</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v13.0.0.0)")]
    public partial class SecuritiesCustomer 
    {
        ...
        public SecuritiesCustomerBody? Body { get; set; }= default!;
    
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v13.0.0.0)")]
    public partial class SecuritiesCustomerBody 
    {
        /// <summary>Illustrates the capacity in which a client is acting.Possible Values : Customer, Broker, Depository, Client, Counterparty, External Account Manager</summary>
        [System.Text.Json.Serialization.JsonPropertyName("customerTypes")]
        public System.Collections.Generic.ICollection<CustomerTypes>? CustomerTypes { get; set; }= default!;
    ...
    /// <summary>SecuritiesCustomerResponse</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v13.0.0.0)")]
    public partial class SecuritiesCustomerResponse 
    {
        [System.Text.Json.Serialization.JsonPropertyName("header")]
        public ScreenHeader? Header { get; set; }= default!;
    
        [System.Text.Json.Serialization.JsonPropertyName("body")]
        public SecuritiesCustomerResponseBody? Body { get; set; }= default!;
    
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v13.0.0.0)")]
    public partial class SecuritiesCustomerResponseBody 
    {
        /// <summary>Illustrates the capacity in which a client is acting.Possible Values : Customer, Broker, Depository, Client, Counterparty, External Account Manager</summary>
        [System.Text.Json.Serialization.JsonPropertyName("customerTypes")]
        public System.Collections.Generic.ICollection<CustomerTypes2>? CustomerTypes { get; set; }= default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v13.0.0.0)")]
    public partial class CustomerTypes2 
    {
        /// <summary>Illustrates the capacity in which a client is acting.Possible Values : Customer, Broker, Depository, Client, Counterparty, External Account Manager</summary>
        [System.Text.Json.Serialization.JsonPropertyName("customerType")]
        [System.ComponentModel.DataAnnotations.StringLength(12)]
