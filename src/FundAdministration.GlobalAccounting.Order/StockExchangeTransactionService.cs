...
namespace FundAdministration.GlobalAccounting.Order.StockExchangeTransaction
{
    ...
    public partial interface IStockExchangeTransactionService
    {
        ...
        System.Threading.Tasks.Task<CreateStockExchangeTransactionSuccessResponse> CreateStockExchangeTransactionAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createStockExchangeTransaction Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateStockExchangeTransactionSuccessResponse> CreateStockExchangeTransactionAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
