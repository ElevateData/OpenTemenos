...
namespace OpenTemenos.FundAdministrations.GlobalInvestor.Party.AgentExceptionCutoffTimes
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("agentexceptioncutofftimes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
