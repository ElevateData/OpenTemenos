...
namespace FundAdministration.GlobalInvestor.Party.CentralRegisters
{
    ...
    public partial interface ICentralRegistersService
    {
        ...
        System.Threading.Tasks.Task<PostCentralRegistersSuccessResponse> PostCentralRegistersAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>postCentralRegisters Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PostCentralRegistersSuccessResponse> PostCentralRegistersAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
