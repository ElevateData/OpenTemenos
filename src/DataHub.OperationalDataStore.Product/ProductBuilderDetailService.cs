...
namespace OpenTemenos.DataHubs.OperationalDataStore.Product.ProductBuilderDetails
{
    ...
    public partial class GetPropertiesResponseBody 
    {
        ...
        [Newtonsoft.Json.JsonProperty("aaProperty", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class GetProductConditionsResponseBody 
    {
        ...
        [Newtonsoft.Json.JsonProperty("productCondition", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
