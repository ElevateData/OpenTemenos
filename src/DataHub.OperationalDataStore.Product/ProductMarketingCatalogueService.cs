...
namespace OpenTemenos.DataHubs.OperationalDataStore.Product.ProductMarketingCatalogues
{
    ...
    /// <summary>getProductMarketingCatalogueResponse</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GetProductMarketingCatalogueResponse 
    {
        [Newtonsoft.Json.JsonProperty("data", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public GetProductMarketingCatalogueResponseBody? Data { get; set; }= default!;
    
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class GetProductMarketingCatalogueResponseBody 
    {
        /// <summary>The file holds the parameter definitions of the enquiries used by the enquiry system</summary>
        [Newtonsoft.Json.JsonProperty("enquiry", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Enquiry>? Enquiry { get; set; }= default!;
