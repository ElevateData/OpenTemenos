...
namespace OpenTemenos.DataHubs.OperationalDataStore.Product.ProductDetails
{
    ...
    public partial class GetPropertyClassesResponseBody 
    {
        ...
        [Newtonsoft.Json.JsonProperty("propertyClass", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
