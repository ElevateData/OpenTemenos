...
namespace Transact.Meta.DwExportProperties
{
    ...
    public partial interface IDwExportPropertiesService
    {
        ...
        System.Threading.Tasks.Task<DWExportPropertiesResponse> UpdateDWExportPropertiesAsync(string dataWarehouseExportId, DWExportProperties payload, bool? validate_only, string? credentials, string? companyId, string? deviceId, string? userRole);
        ...
        /// <returns>DWExportPropertiesResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<DWExportPropertiesResponse> UpdateDWExportPropertiesAsync(string dataWarehouseExportId, DWExportProperties payload, bool? validate_only, string? credentials, string? companyId, string? deviceId, string? userRole, System.Threading.CancellationToken cancellationToken);
        ...
        /// <returns>DWExportPropertiesResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<DWExportPropertiesResponse1> GetDWExportPropertiesAsync(int? page_size, int? page_start, string? page_token, string? credentials, string? companyId, string? deviceId, string? userRole, bool? disablePagination);
        ...
        /// <returns>DWExportPropertiesResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<DWExportPropertiesResponse1> GetDWExportPropertiesAsync(int? page_size, int? page_start, string? page_token, string? credentials, string? companyId, string? deviceId, string? userRole, bool? disablePagination, System.Threading.CancellationToken cancellationToken);
