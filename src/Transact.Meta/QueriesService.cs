...
namespace Transact.Meta.Queries
{
    ...
    public partial interface IQueriesService
    {
        ...
        System.Threading.Tasks.Task<GetQueriesResponse> GetQueriesAsync(int? page_size, int? page_start, string? page_token);
        ...
        /// <returns>getQueriesResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetQueriesResponse> GetQueriesAsync(int? page_size, int? page_start, string? page_token, System.Threading.CancellationToken cancellationToken);
    
        /// <param name="queryId">The query identifier</param>
        /// <returns>getQueryResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetQueryResponse> GetQueryAsync(string queryId);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <param name="queryId">The query identifier</param>
        /// <returns>getQueryResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetQueryResponse> GetQueryAsync(string queryId, System.Threading.CancellationToken cancellationToken);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateQueryResponse> CreateQueryAsync(string queryId, CreateQuery payload, bool? validate_only);
        ...
        /// <returns>createQueryResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateQueryResponse> CreateQueryAsync(string queryId, CreateQuery payload, bool? validate_only, System.Threading.CancellationToken cancellationToken);
