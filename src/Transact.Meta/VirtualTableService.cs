...
namespace Transact.Meta.VirtualTable
{
    ...
    public partial interface IVirtualTableService
    {
        ...
        System.Threading.Tasks.Task<GetVirtualTableDataResponse> GetVirtualTableDataAsync(string virtualTableName, int? page_size, int? page_start, string? page_token);
        ...
        /// <returns>getVirtualTableDataResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetVirtualTableDataResponse> GetVirtualTableDataAsync(string virtualTableName, int? page_size, int? page_start, string? page_token, System.Threading.CancellationToken cancellationToken);
