...
namespace Transact.Holding.Service
{
    ...
    public partial interface IHoldingService
    {
        ...
        System.Threading.Tasks.Task<HoldingsResponse> GetHoldingsAsync(string? customerId, string? holdingsType, string? holdingsId, string? getPreferredHoldings, int? page_size, int? page_start, string? page_token, string? credentials, string? companyId, string? deviceId, string? userRole, bool? disablePagination);
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<HoldingsResponse> GetCustomerHoldingsAsync(string customerId, string? holdingsType, string? holdingsId, string? getPreferredHoldings, int? page_size, int? page_start, string? page_token, string? credentials, string? companyId, string? deviceId, string? userRole, bool? disablePagination);
        ...
        /// <returns>CustomerHoldingsResponse</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<HoldingsResponse> GetCustomerHoldingsAsync(string customerId, string? holdingsType, string? holdingsId, string? getPreferredHoldings, int? page_size, int? page_start, string? page_token, string? credentials, string? companyId, string? deviceId, string? userRole, bool? disablePagination, System.Threading.CancellationToken cancellationToken);
