...
namespace FundAdministration.GlobalInvestor.Reference.Messages
{
    ...
    public partial interface IMessagesService
    {
        ...
        System.Threading.Tasks.Task<PostCmessSuccessResponse> PostCmessAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>postCmess Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PostCmessSuccessResponse> PostCmessAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
