...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Reference.SwapInterestRates
{
    ...
    public partial class _0 
    {
        ...
        [Newtonsoft.Json.JsonProperty("contratNumber", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ContratNumber { get; set; }= default!;
    
        /// <summary>Transaction type identifier</summary>
        [Newtonsoft.Json.JsonProperty("interestPaymentLeg", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? InterestPaymentLeg { get; set; }= default!;
    
        /// <summary>Date</summary>
        [Newtonsoft.Json.JsonProperty("couponBeginDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("swapInterestRates", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
