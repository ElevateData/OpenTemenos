...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Reference.ExchangeRates
{
    ...
    public partial interface IExchangeRateService
    {
        ...
        System.Threading.Tasks.Task<CreateExchangeRateSuccessResponse> CreateExchangeRateAsync(_0BULKPayload payload, string? referenceId = null, string? token = null, string? username = null, string? company = null, string? command = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class _0 
    {
        ...
        [Newtonsoft.Json.JsonProperty("exchangeRateInjectionDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(DateFormatConverter))]
        public System.DateTimeOffset? ExchangeRateInjectionDate { get; set; }= default!;
    
        /// <summary>Exchange Rate Group</summary>
        [Newtonsoft.Json.JsonProperty("exchangeRateGroup", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? ExchangeRateGroup { get; set; }= default!;
    
        /// <summary>Quatation Type</summary>
        [Newtonsoft.Json.JsonProperty("curr", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
