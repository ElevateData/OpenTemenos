...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Reference.SecurityPrices
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.14.5.0 (NJsonSchema v10.5.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial interface ISecurityPriceService
    {
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Creates security market prices</summary>
        /// <param name="payload">createSecurityPrice Payload</param>
        ...
        /// <returns>createSecurityPrice Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateSecurityPriceSuccessResponse> CreateSecurityPriceAsync(_0BULKPayload payload, string? referenceId = null, string? token = null, string? username = null, string? company = null, string? command = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CreateSecurityPriceSuccessheaderResponse 
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CreateSecurityPricerecordsSchema : System.Collections.ObjectModel.Collection<_0>
    {
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CreateSecurityPriceSuccessbodyResponse 
    {
        ...
        public CreateSecurityPricerecordsSchema? Records { get; set; }= default!;
    
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CreateSecurityPriceSuccessResponse 
    {
        [Newtonsoft.Json.JsonProperty("header", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public CreateSecurityPriceSuccessheaderResponse? Header { get; set; }= default!;
    
        [Newtonsoft.Json.JsonProperty("body", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public CreateSecurityPriceSuccessbodyResponse? Body { get; set; }= default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CreateSecurityPriceErrorheaderResponse 
    {
        [Newtonsoft.Json.JsonProperty("pagination", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public PaginationSchema? Pagination { get; set; }= default!;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CreateSecurityPriceErrorbodyResponse 
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.5.2.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CreateSecurityPriceErrorResponse 
    {
        [Newtonsoft.Json.JsonProperty("header", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public CreateSecurityPriceErrorheaderResponse? Header { get; set; }= default!;
    ...
    public partial class _0 
    {
        ...
        /// <summary>Security Price</summary>
        [Newtonsoft.Json.JsonProperty("midPrice", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? MidPrice { get; set; }= default!;
    
        /// <summary>Security Price Date</summary>
        [Newtonsoft.Json.JsonProperty("priceDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>Time course</summary>
        [Newtonsoft.Json.JsonProperty("timeStamp", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TimeStamp { get; set; }= default!;
    
        /// <summary>Price Type ASK BID MID etc Table PRICEMOD in message table</summary>
        [Newtonsoft.Json.JsonProperty("typeOfPriceForMid", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TypeOfPriceForMid { get; set; }= default!;
    
        /// <summary>Provider code like Telekers, Reuters etc</summary>
        ...
        /// <summary>Bid Price used only in case of direct injection in Multifonds</summary>
        ...
        public string? BidPrice { get; set; }= default!;
    
        /// <summary>Type of Price For Bid Used only in case of direct injection in Multifonds</summary>
        [Newtonsoft.Json.JsonProperty("typeOfPriceForBid", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TypeOfPriceForBid { get; set; }= default!;
    
        /// <summary>Offer Price Used only in case of direct injection in Multifonds</summary>
        [Newtonsoft.Json.JsonProperty("askPrice", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? AskPrice { get; set; }= default!;
    
        /// <summary>Type of price for Ask Used only in case of direct injection in Multifonds</summary>
        [Newtonsoft.Json.JsonProperty("typeOfPriceForAsk", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TypeOfPriceForAsk { get; set; }= default!;
        ...
        [Newtonsoft.Json.JsonProperty("inserts", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? Inserts { get; set; }= default!;
    
        /// <summary>NAV Accounting date</summary>
        ...
        public string? NavDate { get; set; }= default!;
    ...
    {
        [Newtonsoft.Json.JsonProperty("securityPrices", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<_0>? SecurityPrices { get; set; }= default!;
