...
namespace OpenTemenos.DataHubs.OperationalDataStore.Holding.PaymentStops
{
    ...
    public partial class GetPaymentStopsResponseBody 
    {
        ...
        [Newtonsoft.Json.JsonProperty("paymentStop", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
