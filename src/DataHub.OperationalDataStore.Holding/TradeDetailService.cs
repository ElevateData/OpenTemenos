...
namespace OpenTemenos.DataHubs.OperationalDataStore.Holding.TradeDetails
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.14.5.0 (NJsonSchema v10.5.2.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial interface ITradeDetailService
    {
    ...
    public partial class GetSellOptionTradesResponseBody 
    {
        ...
        [Newtonsoft.Json.JsonProperty("dxtrade", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class CustomerId 
    {
        ...
        [Newtonsoft.Json.JsonProperty("originalLot", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? OriginalLot { get; set; }= default!;
    
        /// <summary>Indicates the transaction generated by this leg of the trade</summary>
        [Newtonsoft.Json.JsonProperty("priTransKey", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
