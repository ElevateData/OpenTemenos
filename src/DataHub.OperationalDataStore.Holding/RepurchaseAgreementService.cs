...
namespace OpenTemenos.DataHubs.OperationalDataStore.Holding.RepurchaseAgreements
{
    ...
    public partial class GetREPOPositionMovementsResponseBody 
    {
        ...
        [Newtonsoft.Json.JsonProperty("repoPosition", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class GetRESOPositionMovementsResponseBody 
    {
        ...
        [Newtonsoft.Json.JsonProperty("resoPosition", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
