...
namespace FundAdministration.GlobalAccounting.Holding.SpinOff
{
    ...
    public partial interface ISpinOffService
    {
        ...
        System.Threading.Tasks.Task<CreateSpinOffSuccessResponse> CreateSpinOffAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createSpinOff Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateSpinOffSuccessResponse> CreateSpinOffAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("spinOffs")]
