...
namespace FundAdministration.GlobalAccounting.Holding.TermDepositTransaction
{
    ...
    public partial interface ITermDepositTransactionService
    {
        ...
        System.Threading.Tasks.Task<TermDepositTransactionSuccessResponse> TermDepositTransactionAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>termDepositTransaction Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<TermDepositTransactionSuccessResponse> TermDepositTransactionAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
