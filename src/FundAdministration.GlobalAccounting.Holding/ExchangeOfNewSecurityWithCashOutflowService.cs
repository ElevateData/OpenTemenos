...
namespace FundAdministration.GlobalAccounting.Holding.ExchangeOfNewSecurityWithCashOutflow
{
    ...
    public partial interface IExchangeOfNewSecurityWithCashOutflowService
    {
        ...
        System.Threading.Tasks.Task<CreateExchangeOfNewSecurityWithCashOutflowSuccessResponse> CreateExchangeOfNewSecurityWithCashOutflowAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createExchangeOfNewSecurityWithCashOutflow Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateExchangeOfNewSecurityWithCashOutflowSuccessResponse> CreateExchangeOfNewSecurityWithCashOutflowAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
