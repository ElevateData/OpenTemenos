...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.EosSameSecurities
{
    ...
    public partial interface IEosSameSecurityService
    {
        ...
        System.Threading.Tasks.Task<CreateExchangeOfSecurityIntoExistingSecuritySuccessResponse> CreateExchangeOfSecurityIntoExistingSecurityAsync(_0BULKPayload payload, string? referenceId = null, string? token = null, string? username = null, string? company = null, string? command = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class _0 
    {
        ...
        [Newtonsoft.Json.JsonProperty("impactedNumberOfQuantity", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? ImpactedNumberOfQuantity { get; set; }= default!;
    
        /// <summary>Old securities</summary>
        [Newtonsoft.Json.JsonProperty("adjustmentOptionAdditionOrReplacementOrSubtraction", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("exchangeOfSecurityIntoExistingSecurities", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
