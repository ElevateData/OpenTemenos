...
namespace FundAdministration.GlobalAccounting.Holding.IrsTransactions
{
    ...
    public partial interface IIrsTransactionsService
    {
        ...
        System.Threading.Tasks.Task<IrsTransactionsSuccessResponse> IrsTransactionsAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>irsTransactions Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<IrsTransactionsSuccessResponse> IrsTransactionsAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
