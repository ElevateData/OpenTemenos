...
namespace FundAdministration.GlobalAccounting.Holding.FundShareTransaction
{
    ...
    public partial interface IFundShareTransactionService
    {
        ...
        System.Threading.Tasks.Task<FundSharetransactionSuccessResponse> FundSharetransactionAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>fundSharetransaction Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<FundSharetransactionSuccessResponse> FundSharetransactionAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
