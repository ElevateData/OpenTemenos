...
namespace FundAdministration.GlobalAccounting.Holding.OptionMaturity
{
    ...
    public partial interface IOptionMaturityService
    {
        ...
        System.Threading.Tasks.Task<CreateOptionMaturitySuccessResponse> CreateOptionMaturityAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createOptionMaturity Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateOptionMaturitySuccessResponse> CreateOptionMaturityAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("optionMaturities")]
