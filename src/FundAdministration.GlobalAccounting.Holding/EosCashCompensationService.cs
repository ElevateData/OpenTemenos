...
namespace FundAdministration.GlobalAccounting.Holding.EosCashCompensation
{
    ...
    public partial interface IEosCashCompensationService
    {
        ...
        System.Threading.Tasks.Task<CreateExchangeOfSecurityForCashCompensationSuccessResponse> CreateExchangeOfSecurityForCashCompensationAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createExchangeOfSecurityForCashCompensation Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateExchangeOfSecurityForCashCompensationSuccessResponse> CreateExchangeOfSecurityForCashCompensationAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("exchangeOfSecurityForCashCompensations")]
