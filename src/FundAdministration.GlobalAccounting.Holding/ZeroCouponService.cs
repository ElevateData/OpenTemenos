...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.ZeroCoupons
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("zeroCoupons", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
