...
namespace FundAdministration.GlobalAccounting.Holding.ZeroCoupon
{
    ...
    public partial interface IZeroCouponService
    {
        ...
        System.Threading.Tasks.Task<CreateZeroCouponSuccessResponse> CreateZeroCouponAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createZeroCoupon Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateZeroCouponSuccessResponse> CreateZeroCouponAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
