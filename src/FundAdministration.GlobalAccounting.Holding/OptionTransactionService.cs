...
namespace FundAdministration.GlobalAccounting.Holding.OptionTransaction
{
    ...
    public partial interface IOptionTransactionService
    {
        ...
        System.Threading.Tasks.Task<CreateOptionTransactionSuccessResponse> CreateOptionTransactionAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createOptionTransaction Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateOptionTransactionSuccessResponse> CreateOptionTransactionAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("optionTransactions")]
