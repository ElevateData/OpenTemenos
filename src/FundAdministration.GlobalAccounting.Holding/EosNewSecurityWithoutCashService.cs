...
namespace FundAdministration.GlobalAccounting.Holding.EosNewSecurityWithoutCash
{
    ...
    public partial interface IEosNewSecurityWithoutCashService
    {
        ...
        System.Threading.Tasks.Task<CreateExchangeOfNewSecurityWithOutCashSuccessResponse> CreateExchangeOfNewSecurityWithOutCashAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createExchangeOfNewSecurityWithOutCash Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateExchangeOfNewSecurityWithOutCashSuccessResponse> CreateExchangeOfNewSecurityWithOutCashAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("exchangeOfNewSecurityWithOutCashes")]
