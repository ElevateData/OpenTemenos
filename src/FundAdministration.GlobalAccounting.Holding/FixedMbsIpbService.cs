...
namespace FundAdministration.GlobalAccounting.Holding.FixedMbsIpb
{
    ...
    public partial interface IFixedMbsIpbService
    {
        ...
        System.Threading.Tasks.Task<CreateFixedMbsOrIpbSuccessResponse> CreateFixedMbsOrIpbAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createFixedMbsOrIpb Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateFixedMbsOrIpbSuccessResponse> CreateFixedMbsOrIpbAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("fixedMbsOrIpbs")]
