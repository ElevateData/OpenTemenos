...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.Equities
{
    ...
    public partial interface IEquityService
    {
        ...
        System.Threading.Tasks.Task<CreateEquitySuccessResponse> CreateEquityAsync(_0BULKPayload payload, string? referenceId = null, string? token = null, string? username = null, string? company = null, string? command = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    {
        [Newtonsoft.Json.JsonProperty("equities", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
