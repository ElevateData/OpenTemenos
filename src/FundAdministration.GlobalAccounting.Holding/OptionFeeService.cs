...
namespace FundAdministration.GlobalAccounting.Holding.OptionFee
{
    ...
    public partial interface IOptionFeeService
    {
        ...
        System.Threading.Tasks.Task<CreateOptionFeeSuccessResponse> CreateOptionFeeAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createOptionFee Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateOptionFeeSuccessResponse> CreateOptionFeeAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("optionFees")]
