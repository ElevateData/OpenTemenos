...
namespace FundAdministration.GlobalAccounting.Holding.ExchangeOfNewSecurityWithCashInflow
{
    ...
    public partial interface IExchangeOfNewSecurityWithCashInflowService
    {
        ...
        System.Threading.Tasks.Task<CreateExchangeOfNewSecurityWithCashInflowSuccessResponse> CreateExchangeOfNewSecurityWithCashInflowAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createExchangeOfNewSecurityWithCashInflow Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateExchangeOfNewSecurityWithCashInflowSuccessResponse> CreateExchangeOfNewSecurityWithCashInflowAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("exchangeOfNewSecurityWithCashInflows")]
