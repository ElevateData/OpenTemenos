...
namespace FundAdministration.GlobalAccounting.Holding.ReverseStockSplit
{
    ...
    public partial interface IReverseStockSplitService
    {
        ...
        System.Threading.Tasks.Task<GetReverseStockSplitSuccessResponse> GetReverseStockSplitAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>getReverseStockSplit Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetReverseStockSplitSuccessResponse> GetReverseStockSplitAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("reverseStockSplits")]
