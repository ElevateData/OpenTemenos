...
namespace FundAdministration.GlobalAccounting.Holding.CiaSubscriptionRight
{
    ...
    public partial interface ICiaSubscriptionRightService
    {
        ...
        System.Threading.Tasks.Task<CreateCapitalIncreaseWithAllotmentOfSubscriptionRightsSuccessResponse> CreateCapitalIncreaseWithAllotmentOfSubscriptionRightsAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("capitalIncreaseWithAllotmentOfSubscriptionRightses")]
