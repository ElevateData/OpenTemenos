...
namespace FundAdministration.GlobalAccounting.Holding.CapitalIncreaseWithoutIssueOfSubscriptionRights
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.14.5.0 (NJsonSchema v10.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial interface ICapitalIncreaseWithoutIssueOfSubscriptionRightsService
    {
        ...
        System.Threading.Tasks.Task<CreateCapitalIncreaseWithoutIssueOfSubscriptionRightSuccessResponse> CreateCapitalIncreaseWithoutIssueOfSubscriptionRightAsync(string? referenceId, string? token, string? username, string? company, string? command, _0Payload payload);
        ...
        /// <returns>createCapitalIncreaseWithoutIssueOfSubscriptionRight Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateCapitalIncreaseWithoutIssueOfSubscriptionRightSuccessResponse> CreateCapitalIncreaseWithoutIssueOfSubscriptionRightAsync(string? referenceId, string? token, string? username, string? company, string? command, _0Payload payload, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class _0 
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("correctionRatio")]
