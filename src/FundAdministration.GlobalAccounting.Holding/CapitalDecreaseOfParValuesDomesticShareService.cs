...
namespace FundAdministration.GlobalAccounting.Holding.CapitalDecreaseOfParValuesDomesticShare
{
    ...
    public partial interface ICapitalDecreaseOfParValuesDomesticShareService
    {
        ...
        System.Threading.Tasks.Task<CreateCapitalDecreaseOfParValueDomesticWithCostAdjustmentSuccessResponse> CreateCapitalDecreaseOfParValueDomesticWithCostAdjustmentAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createCapitalDecreaseOfParValueDomesticWithCostAdjustment Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateCapitalDecreaseOfParValueDomesticWithCostAdjustmentSuccessResponse> CreateCapitalDecreaseOfParValueDomesticWithCostAdjustmentAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
