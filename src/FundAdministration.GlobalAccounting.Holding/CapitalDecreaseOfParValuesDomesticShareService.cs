...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.CapitalDecreaseOfParValuesDomesticShares
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("capitalDecreaseOfParValueDomesticWithCostAdjustments", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
