...
namespace FundAdministration.GlobalAccounting.Holding.EosMultipleSecurity
{
    ...
    public partial interface IEosMultipleSecurityService
    {
        ...
        System.Threading.Tasks.Task<CreateExchangeOfSecurityIntoSeveralSecuritiesSuccessResponse> CreateExchangeOfSecurityIntoSeveralSecuritiesAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createExchangeOfSecurityIntoSeveralSecurities Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateExchangeOfSecurityIntoSeveralSecuritiesSuccessResponse> CreateExchangeOfSecurityIntoSeveralSecuritiesAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class _0 
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("correctionPercentage")]
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("exchangeOfSecurityIntoSeveralSecurities")]
