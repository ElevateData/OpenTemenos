...
namespace FundAdministration.GlobalAccounting.Holding.ForwardForeignExchangeRepayment
{
    ...
    public partial interface IForwardForeignExchangeRepaymentService
    {
        ...
        System.Threading.Tasks.Task<CreateForwardForeignExchangeRepaymentSuccessResponse> CreateForwardForeignExchangeRepaymentAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createForwardForeignExchangeRepayment Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateForwardForeignExchangeRepaymentSuccessResponse> CreateForwardForeignExchangeRepaymentAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("forwardForeignExchangeRepayments")]
