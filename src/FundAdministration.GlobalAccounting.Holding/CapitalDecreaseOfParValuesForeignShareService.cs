...
namespace FundAdministration.GlobalAccounting.Holding.CapitalDecreaseOfParValuesForeignShare
{
    ...
    public partial interface ICapitalDecreaseOfParValuesForeignShareService
    {
        ...
        System.Threading.Tasks.Task<CreateCapitalDecreaseOfParValueForeignWithCostAdjustmentSuccessResponse> CreateCapitalDecreaseOfParValueForeignWithCostAdjustmentAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("capitalDecreaseOfParValueForeignWithCostAdjustments")]
