...
namespace FundAdministration.GlobalAccounting.Holding.FutureFee
{
    ...
    public partial interface IFutureFeeService
    {
        ...
        System.Threading.Tasks.Task<CreateFutureFeeSuccessResponse> CreateFutureFeeAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createFutureFee Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateFutureFeeSuccessResponse> CreateFutureFeeAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
