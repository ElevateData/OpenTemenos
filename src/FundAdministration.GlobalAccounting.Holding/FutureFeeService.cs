...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.FutureFees
{
    ...
    public partial class _0 
    {
        ...
        [Newtonsoft.Json.JsonProperty("temenosInternalSecurityId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("futureFees", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
