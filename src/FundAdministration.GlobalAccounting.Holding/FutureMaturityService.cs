...
namespace FundAdministration.GlobalAccounting.Holding.FutureMaturity
{
    ...
    public partial interface IFutureMaturityService
    {
        ...
        System.Threading.Tasks.Task<CreateFutureMaturitySuccessResponse> CreateFutureMaturityAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createFutureMaturity Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateFutureMaturitySuccessResponse> CreateFutureMaturityAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("futureMaturities")]
