...
namespace FundAdministration.GlobalAccounting.Holding.OptionExercise
{
    ...
    public partial interface IOptionExerciseService
    {
        ...
        System.Threading.Tasks.Task<CreateOptionExerciseSuccessResponse> CreateOptionExerciseAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createOptionExercise Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateOptionExerciseSuccessResponse> CreateOptionExerciseAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class _0 
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("cashOrPhysicalDeliveryInCaseOfOptionExercise")]
        ...
        [System.Text.Json.Serialization.JsonPropertyName("marketPriceInCaseOfOptionExerciseInCashDelivery")]
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("optionExercises")]
