...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.CallDepositTransactions
{
    ...
    public partial class _0 
    {
        ...
        [Newtonsoft.Json.JsonProperty("rollType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("callDepositTransactionses", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
