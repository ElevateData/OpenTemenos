...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.SpotForeignExchanges
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("spotForeignExchanges", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
