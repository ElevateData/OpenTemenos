...
namespace FundAdministration.GlobalAccounting.Holding.SpotForeignExchange
{
    ...
    public partial interface ISpotForeignExchangeService
    {
        ...
        System.Threading.Tasks.Task<CreateSpotForeignExchangeSuccessResponse> CreateSpotForeignExchangeAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createSpotForeignExchange Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateSpotForeignExchangeSuccessResponse> CreateSpotForeignExchangeAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
