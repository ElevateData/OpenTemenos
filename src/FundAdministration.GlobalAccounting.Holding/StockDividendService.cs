...
namespace FundAdministration.GlobalAccounting.Holding.StockDividend
{
    ...
    public partial interface IStockDividendService
    {
        ...
        System.Threading.Tasks.Task<CreateStockDividendSuccessResponse> CreateStockDividendAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createStockDividend Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateStockDividendSuccessResponse> CreateStockDividendAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("stockDividends")]
