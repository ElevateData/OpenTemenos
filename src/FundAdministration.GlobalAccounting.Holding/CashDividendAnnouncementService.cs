...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.CashDividendAnnouncements
{
    ...
    public partial class _0 
    {
        ...
        [Newtonsoft.Json.JsonProperty("dividendPerUnit", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? DividendPerUnit { get; set; }= default!;
    
        /// <summary>Denotes the currency like EUR,USD etc</summary>
        [Newtonsoft.Json.JsonProperty("dividendCurrency", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DividendCurrency { get; set; }= default!;
    
        /// <summary>Recoverable tax percentage at dividend announcement , type 1</summary>
        [Newtonsoft.Json.JsonProperty("recoverableTaxPercentage", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("unrecoverableTaxPercentage", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("netAmountFlag", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? NetAmountFlag { get; set; }= default!;
    
        /// <summary>Rate of Tax payable on the income , type of tax 1</summary>
        [Newtonsoft.Json.JsonProperty("payableTaxPercentage", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("conduitForeignIncomeRate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("cashDividendAnnouncements", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
