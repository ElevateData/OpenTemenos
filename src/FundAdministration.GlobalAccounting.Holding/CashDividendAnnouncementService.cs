...
namespace FundAdministration.GlobalAccounting.Holding.CashDividendAnnouncement
{
    ...
    public partial interface ICashDividendAnnouncementService
    {
        ...
        System.Threading.Tasks.Task<CreateCashDividendAnnouncementSuccessResponse> CreateCashDividendAnnouncementAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createCashDividendAnnouncement Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateCashDividendAnnouncementSuccessResponse> CreateCashDividendAnnouncementAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
