...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.OptionTransactionsRebookings
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("optionTransactionsRebookings", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
