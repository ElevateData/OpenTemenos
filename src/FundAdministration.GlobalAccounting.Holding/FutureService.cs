...
namespace OpenTemenos.FundAdministrations.GlobalAccounting.Holding.Futures
{
    ...
    public partial class _0 
    {
        ...
        [Newtonsoft.Json.JsonProperty("instrumenID", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("underlyingAssetType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("primaryExchangeCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("externalIdentificationCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("sedolId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("isinId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("cusipID", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? CusipID { get; set; }= default!;
    
        /// <summary>Security provider4 code</summary>
        [Newtonsoft.Json.JsonProperty("bloomberg", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? Bloomberg { get; set; }= default!;
    
        /// <summary>Security Id code at provider4</summary>
        [Newtonsoft.Json.JsonProperty("bloombergId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? BloombergId { get; set; }= default!;
    
        /// <summary>Security provider5 code</summary>
        [Newtonsoft.Json.JsonProperty("wertpapier", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? Wertpapier { get; set; }= default!;
    
        /// <summary>Security Id code at provider5</summary>
        [Newtonsoft.Json.JsonProperty("wertpapierID", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("providerCodeOfUnderlyingId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("derivativeTypeForO", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? DerivativeTypeForO { get; set; }= default!;
    
        /// <summary>Type of underlying Security</summary>
        [Newtonsoft.Json.JsonProperty("typeOfUnderlyingInstrument", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string? TypeOfUnderlyingInstrument { get; set; }= default!;
    
        /// <summary>Style of option or future</summary>
        [Newtonsoft.Json.JsonProperty("optionStyle", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("futures", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
