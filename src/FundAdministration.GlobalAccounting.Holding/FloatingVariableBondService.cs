...
namespace FundAdministration.GlobalAccounting.Holding.FloatingVariableBond
{
    ...
    public partial interface IFloatingVariableBondService
    {
        ...
        System.Threading.Tasks.Task<CreateFloatingOrVariableBondSuccessResponse> CreateFloatingOrVariableBondAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createFloatingOrVariableBond Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateFloatingOrVariableBondSuccessResponse> CreateFloatingOrVariableBondAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("floatingOrVariableBonds")]
