...
namespace FundAdministration.GlobalAccounting.Holding.CapitalIIncreaseWithExerciseOfSubscriptionRights
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.14.5.0 (NJsonSchema v10.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial interface ICapitalIIncreaseWithExerciseOfSubscriptionRightsService
    {
        ...
        System.Threading.Tasks.Task<CreateCapitalIncreaseWithExerciseOfSubscriptionRightSuccessResponse> CreateCapitalIncreaseWithExerciseOfSubscriptionRightAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createCapitalIncreaseWithExerciseOfSubscriptionRight Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateCapitalIncreaseWithExerciseOfSubscriptionRightSuccessResponse> CreateCapitalIncreaseWithExerciseOfSubscriptionRightAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("capitalIncreaseWithExerciseOfSubscriptionRightses")]
