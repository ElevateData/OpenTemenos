...
namespace FundAdministration.GlobalAccounting.Holding.StockExchangeTransactionFee
{
    ...
    public partial interface IStockExchangeTransactionFeeService
    {
        ...
        System.Threading.Tasks.Task<CreateStockExchangeTransactionFeeSuccessResponse> CreateStockExchangeTransactionFeeAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createStockExchangeTransactionFee Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreateStockExchangeTransactionFeeSuccessResponse> CreateStockExchangeTransactionFeeAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class _0 
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("transactionFeesCurrency")]
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("stockExchangeTransactionFees")]
