...
namespace FundAdministration.GlobalAccounting.Holding.PikBond
{
    ...
    public partial interface IPikBondService
    {
        ...
        System.Threading.Tasks.Task<CreatePikBondSuccessResponse> CreatePikBondAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>createPikBond Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<CreatePikBondSuccessResponse> CreatePikBondAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class _0 
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("capitalizationRateForPikBonds")]
    ...
    {
        [System.Text.Json.Serialization.JsonPropertyName("pikBonds")]
