...
namespace FundAdministration.GlobalInvestor.Product.ExchangeGroups
{
    ...
    public partial interface IExchangeGroupsService
    {
        ...
        System.Threading.Tasks.Task<PostExchangeGroupSuccessResponse> PostExchangeGroupAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>postExchangeGroup Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PostExchangeGroupSuccessResponse> PostExchangeGroupAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
