...
namespace FundAdministration.GlobalInvestor.Order.OrderNotification
{
    ...
    public partial interface IOrderNotificationService
    {
        ...
        System.Threading.Tasks.Task<PostordernotificationSuccessResponse> PostordernotificationAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>postordernotification Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PostordernotificationSuccessResponse> PostordernotificationAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
