...
namespace FundAdministration.GlobalInvestor.Order.Order
{
    ...
    public partial interface IOrderService
    {
        ...
        System.Threading.Tasks.Task<PostOrdersSuccessResponse> PostOrdersAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>postOrders Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PostOrdersSuccessResponse> PostOrdersAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
