...
namespace FundAdministration.GlobalInvestor.Order.Payments
{
    ...
    public partial interface IPaymentsService
    {
        ...
        System.Threading.Tasks.Task<PostpaymentsSuccessResponse> PostpaymentsAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>postpayments Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PostpaymentsSuccessResponse> PostpaymentsAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
