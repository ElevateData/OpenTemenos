...
namespace FundAdministration.GlobalInvestor.Order.Announcements
{
    ...
    public partial interface IAnnouncementsService
    {
        ...
        System.Threading.Tasks.Task<PostDividendPaymentSuccessResponse> PostDividendPaymentAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload);
        ...
        /// <returns>postDividendPayment Success Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<PostDividendPaymentSuccessResponse> PostDividendPaymentAsync(string? referenceId, string? token, string? username, string? company, string? command, _0BULKPayload payload, System.Threading.CancellationToken cancellationToken);
