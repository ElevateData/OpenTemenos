...
namespace OpenTemenos.Tests.Transact.Enterprise
{
    ...
    public class EnterpriseProductPricingServiceTests : CredentialManagement
    {
        ...
        {
            var result = _client.EnterpriseProductPricingService.GetActivityChargeAmountAsync(BaseContractReference, null, null,
        ...
        {
            var result = _client.EnterpriseProductPricingService.GetPeriodicChargesAmountAsync(BaseContractReference, null, null, null,
        ...
        {
            var result = _client.EnterpriseProductPricingService.GetInterestRateAsync(BaseContractReference, null, null, null, null,
        ...
        {
            var result = _client.EnterpriseProductPricingService.GetTransactionPricingRequestAsync(BaseContractReference, null, null,
        ...
        {
            var result = _client.EnterpriseProductPricingService
                .GetPricingDetailsEventListAsync(ArrangementId, null, null, null, null, null, null, null, null, null).Result;
            Assert.IsNotNull(result.Body);
        }
        [TestMethod]
        ...
        {
            var result = _client.EnterpriseProductPricingService.GetContractEventListAsync(BaseContractReference, null, null, null, null,
