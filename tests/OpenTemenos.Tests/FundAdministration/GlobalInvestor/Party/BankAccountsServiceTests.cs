...
public class BankAccountsServiceTests : CredentialManagement
{
    ...
    public void PostBankAccountsByParentAsync()
    {
        ...
        var result = _client.BankAccountService.PostbankaccountsByParentAsync(null, null, null, null, null, payload).Result;
    ...
    {
        var result = _client.BankAccountService.GetbankaccountsByInternalIdAsync(null, null, null, null, null, null, null, null, null, null, InternalId).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    public void PutBankAccountsByIdAsync()
    {
        ...
        var payload = new _0Payload();
        var result = _client.BankAccountService.PutbankaccountsByIdAsync(null, null, null, null, null, internalId, payload).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    public void DeleteBankAccountsByIdAsync()
    {
        var internalId = string.Empty;
        var payload = new _0Payload();
        var result = _client.BankAccountService.DeletebankaccountsByIdAsync(null, null, null, null, null, internalId, payload).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    {
        var payload = new _0Payload();
        var result = _client.BankAccountService.PostbankaccountsByParentProdAsync(null, null, null, null, null, payload).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    {
        var payload = new _0BULKPayload();
        var result = _client.BankAccountService.DeletebankaccountsProdAsync(null, null, null, null, null, payload).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    {
        var result = _client.BankAccountService.GetbankaccountsByInternalIdProdAsync(null, null, null, null, null, null, null, null, null, null, InternalId).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    public void PutBankAccountsByIdProdAsync()
    {
        var internalId = string.Empty;
        var payload = new _0Payload();
        var result = _client.BankAccountService.PutbankaccountsByIdProdAsync(null, null, null, null, null, internalId, payload).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    public void DeleteBankAccountsByIdProdAsync()
    {
        var internalId = string.Empty;
        var payload = new _0Payload();
        var result = _client.BankAccountService.DeletebankaccountsByIdProdAsync(null, null, null, null, null, internalId, payload).Result;
        Assert.IsNotNull(result.Body);
    }
}