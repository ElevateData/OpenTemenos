...
public class JointAccountsServiceTests : CredentialManagement
{
    ...
    public void PostJointAccountsByParentAsync()
    {
        ...
        var result = _client.JointAccountService.PostJointaccountsByParentAsync(null, null, null, null, null, payload).Result;
    ...
    {
        var result = _client.JointAccountService.GetJointaccountsByInternalIdAsync(null, null, null, null, null, null, null, null, null, null, InternalId).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    public void PutJointAccountsByIdAsync()
    {
        ...
        var payload = new _0Payload();
        var result = _client.JointAccountService.PutJointaccountsByIdAsync(null, null, null, null, null, internalId, payload).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    public void DeleteJointAccountsByIdAsync()
    {
        var internalId = string.Empty;
        var payload = new _0Payload();
        var result = _client.JointAccountService.DeleteJointaccountsByIdAsync(null, null, null, null, null, internalId, payload).Result;
        Assert.IsNotNull(result.Body);
    }
}