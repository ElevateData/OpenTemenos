...
public class FundManagersServiceTests : CredentialManagement
{
    ...
    public void PostFundManagersByParentAsync()
    {
        ...
        var result = _client.FundManagerService.PostFundmanagersByParentAsync(null, null, null, null, null, payload).Result;
    ...
    {
        var result = _client.FundManagerService.GetFundmanagersByInternalIdAsync(null, null, null, null, null, null, null, null, null, null, InternalId).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    public void PutFundManagersByIdAsync()
    {
        ...
        var payload = new _0Payload();
        var result = _client.FundManagerService.PutFundmanagersByIdAsync(null, null, null, null, null, internalId, payload).Result;
        Assert.IsNotNull(result.Body);
    }
    ...
    public void DeleteFundManagersByIdAsync()
    {
        var internalId = string.Empty;
        var payload = new _0Payload();
        var result = _client.FundManagerService.DeleteFundmanagersByIdAsync(null, null, null, null, null, internalId, payload).Result;
        Assert.IsNotNull(result.Body);
    }
}